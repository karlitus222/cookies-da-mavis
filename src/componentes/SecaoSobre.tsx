...
export function SecaoSobre() {
  return (
    <section className="scroll-reveal px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24" id="sobre">
      <div className="mx-auto grid max-w-7xl gap-7 sm:gap-10 lg:grid-cols-[0.85fr_1fr] lg:items-center">
        <div className="relative">
          ...
          <Image
            src={caminhoAsset(brandInfo.aboutImage.src)}
        ...
        <div>
          <DicaEdicao>historia real editavel</DicaEdicao>
          <TituloSecao
            eyebrow="Sobre"
