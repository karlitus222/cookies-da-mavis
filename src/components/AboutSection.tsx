...
export function AboutSection() {
  return (
    <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-24" id="sobre">
      <div className="mx-auto grid max-w-7xl gap-7 sm:gap-10 lg:grid-cols-[0.85fr_1fr] lg:items-center">
        ...
        <div>
          ...
          />
          <div className="mt-5 rounded-[1.5rem] border border-[var(--color-primary)]/10 bg-[var(--color-surface)] p-4 text-sm leading-7 text-[var(--color-muted)] shadow-sm sm:mt-8 sm:rounded-[2rem] sm:p-8 sm:text-base sm:leading-8">
            <p>{brandInfo.story}</p>
          </div>

          <div className="mt-4 grid gap-3 sm:mt-6 sm:grid-cols-2 sm:gap-4">
            <div className="rounded-2xl bg-[var(--color-surface-strong)]/60 p-4 sm:rounded-3xl sm:p-5">
